...
skip = (
    ...
    'app.normandy', 'app.shield', 'app.update',
    'browser.aboutwelcome', 'browser.bookmarks',
    'browser.contextual-services', 'browser.contentblocking', 'browser.crashReports',
    'browser.download.lastDir', 'browser.download.panel.shown',
    'browser.download.viewableInternally', 'browser.engagement',
    'browser.firefox-view', 'browser.laterrun', 'browser.migration',
    'browser.newtabpage.activity-stream', 'browser.newtabpage.pinned',
    'browser.newtabpage.storageVersion',
    'browser.pageActions', 'browser.pagethumbnails',
    'browser.preonboarding', 'browser.preferences.experimental',
    'browser.proton', 'browser.region',
    'browser.rights', 'browser.safebrowsing', 'browser.search.region',
    'browser.search.serpEvent', 'browser.search.totalSearches',
    'browser.sessionstore', 'browser.shell', 'browser.slowStartup',
    'browser.startup.couldRestore', 'browser.startup.homepage_override',
    ...
    'extensions.pictureinpicture', 'extensions.quarantinedDomains',
    'extensions.signatureCheckpoint',
    'extensions.systemAddon', 'extensions.ui.',
    'extensions.webcompat', 'extensions.webextensions',
    'gecko.handlerService',
    'identity', 'idle.lastDailyNotification',
    'media.gmp', 'media.videocontrols.picture-in-picture',
    'messaging-system-action',
    'network.trr', 'nimbus.',
    'pdfjs', 'places', 'pref.downloads', 'pref.privacy', 'print',
    'privacy.bounceTrackingProtection', 'privacy.purge_trackers',
    'privacy.sanitize',
    'reader', 'services', 'sidebar.backupState',
    'signon', 'storage', 'telemetry',
    'toolkit.profiles', 'toolkit.startup', 'toolkit.telemetry',
    'trailhead.',
    'widget',
)
